...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeamClient.git_password'
        db.add_column('codemanagement_teamclient', 'git_password',
                      self.gf('django.db.models.fields.CharField')(default='1aa8b9350abd8be', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TeamClient.git_password'
        db.delete_column('codemanagement_teamclient', 'git_password')
    ...
    models = {
        ...
        'codemanagement.teamclient': {
            ...
            'git_password': ('django.db.models.fields.CharField', [], {'default': "'b7c0aec5bfeb5a1'", 'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'repository': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['greta.Repository']", 'unique': 'True'}),
