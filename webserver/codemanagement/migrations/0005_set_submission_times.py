...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        TeamSubmission = orm['codemanagement.teamsubmission']
        for submission in TeamSubmission.objects.all():
            submission.submission_time = submission.tag_time
            submission.save()
    ...
    models = {
        ...
        'codemanagement.teamclient': {
            ...
            'git_password': ('django.db.models.fields.CharField', [], {'default': "'74af0ba73cb2b26'", 'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'repository': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['greta.Repository']", 'unique': 'True'}),
