...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeamSubmission.submission_time'
        db.add_column('codemanagement_teamsubmission', 'submission_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 4, 9, 0, 0), blank=True),
                      keep_default=False)

        # Adding unique constraint on 'TeamSubmission', fields ['name', 'team']
        db.create_unique('codemanagement_teamsubmission', ['name', 'team_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'TeamSubmission', fields ['name', 'team']
        db.delete_unique('codemanagement_teamsubmission', ['name', 'team_id'])

        # Deleting field 'TeamSubmission.submission_time'
        db.delete_column('codemanagement_teamsubmission', 'submission_time')
    ...
    models = {
        ...
        'codemanagement.teamclient': {
            ...
            'git_password': ('django.db.models.fields.CharField', [], {'default': "'ce2e6f8050ec71a'", 'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'repository': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['greta.Repository']", 'unique': 'True'}),
