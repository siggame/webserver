...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('hermes_teamstats', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('team', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['competition.Team'], unique=True)),
            ('data_field', self.gf('django.db.models.fields.TextField')(default='null', null=True)),
        ))
        db.send_create_signal('hermes', ['TeamStats'])


    def backwards(self, orm):
        # Deleting model 'TeamStats'
        db.delete_table('hermes_teamstats')
    ...
    models = {
        ...
        'hermes.teamstats': {
            ...
            'data_field': ('django.db.models.fields.TextField', [], {'default': "'null'", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
